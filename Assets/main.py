...
def render_map(test_map):
	...
	if True in pygame.mouse.get_pressed():
		sc.blit(pygame.transform.scale(cursor, cursor_size), pygame.mouse.get_pos())
	else:
		sc.blit(pygame.transform.scale(b_cursor, cursor_size), pygame.mouse.get_pos())
